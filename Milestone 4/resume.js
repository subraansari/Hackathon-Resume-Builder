...
window.addEventListener('load', () => {
    ...
    let resDesignation = document.getElementById("res-designation");
    resDesignation.textContent = designation;
    resDesignation.style.textTransform = "uppercase";
    let resphone = document.getElementById("res-phone");
    resphone.textContent = phone;
    let resemail = document.getElementById("res-email");
    resemail.textContent = email;
    let resAddress = document.getElementById("res-address");
    resAddress.textContent = address;
    let reslinkedin = document.getElementById("res-linkedin");
    reslinkedin.textContent = linkedin;
    let resprofile = document.getElementById("res-profile");
    resprofile.textContent = profile;
    let resCollege = document.getElementById("res-college");
    resCollege.textContent = university;
    resCollege.style.textTransform = "uppercase";
    let resdegree = document.getElementById("res-degree");
